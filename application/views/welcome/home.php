...
<div id="wrapper">
	...
	<div class="inner">
		...
		<div id="three-cols">
			<div class="col first">
				<div class="heading">
					<img src="<?php echo base_url();?>images/professor.png" alt="Column Image" />
					<div class="col-title">
						<h4>Tutors & Professors</h4>
						<h5>Curabitur eget nibh id enim</h5>
					</div>
					<div class="cl">&nbsp;</div>
				</div>
				<p>Curabitur eget nibh id enim laoreet euismod eget ac orci. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae.</p>
				<a title="Read More" class="button_small" href="#">Read More</a>
			</div>
			<div class="col">
				<div class="heading">
					<img src="<?php echo base_url();?>images/student.png" alt="Column Image" />
					<div class="col-title">
						<h4>Students</h4>
						<h5>Curabitur eget nibh id enim</h5>
					</div>
			...
			<div class="col">
				<div class="heading">
					<img src="<?php echo base_url();?>images/search.png" alt="Column Image" />
					<div class="col-title">
						<h4>Find Tutors/Students</h4>
						<h5>Curabitur eget nibh id enim</h5>
					</div>
					<div class="cl">&nbsp;</div>
				</div>
		...
		<div id="main">
			...
			<div id="content">
				<div class="post">
					...
					<img src="<?php echo base_url();?>images/post-img.jpg" alt="Post Image" />
